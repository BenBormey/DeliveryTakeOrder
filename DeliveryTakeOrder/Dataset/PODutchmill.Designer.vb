...
Partial Public Class PODutchmill
    ...
    Partial Public Class XrPODutchmillDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddXrPODutchmillRow(ByVal Barcode As String, ByVal ProName As String, ByVal Remark As String, ByVal Size As String, ByVal QtyPCase As Integer, ByVal TotalOrder As Decimal, ByVal PiecesPerTray As Decimal, ByVal TotalExtraLeft As String, ByVal TotalOrderToThailand As String, ByVal TotalTray As String) As XrPODutchmillRow
            Dim rowXrPODutchmillRow As XrPODutchmillRow = CType(Me.NewRow,XrPODutchmillRow)
            Dim columnValuesArray() As Object = New Object() {Barcode, ProName, Remark, Size, QtyPCase, TotalOrder, PiecesPerTray, TotalExtraLeft, TotalOrderToThailand, TotalTray}
