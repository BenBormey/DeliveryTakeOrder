...
Public Class FrmDutchmillTakeOrderQty
    ...
    Private Sub FrmDutchmillTakeOrderQty_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        TxtNewCTNOrder.Focus()
    End Sub
    ...
    Private Sub FrmDutchmillTakeOrderQty_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LoadingInitialized()
            ...
            Try
                ...
                <SQL>
                    <![CDATA[
                        ...
                        DECLARE @vNewCTNOrder AS DECIMAL(18,0) = {4};
                ...
                query = String.Format(query, DatabaseName, vId, vBarcode, vNewPcsOrder, vNewCTNOrder)
