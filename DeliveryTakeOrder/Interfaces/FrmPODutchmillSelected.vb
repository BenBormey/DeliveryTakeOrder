...
Public Class FrmPODutchmillSelected
    ...
    Private Sub FrmPODutchmillSelected_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Me.Dispose()
    End Sub

    Private Sub FrmPODutchmillSelected_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LoadingInitialized()
